Current status: The schedule HTML is being generated by
scripts/sched.pl, to be run from within that directory. I'm using
Emacs, so I compile using the scripts/Makefile.

For some reason the filtering isn't working for the programs.
